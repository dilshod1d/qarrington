...
const Page = () => {
    ...
    return (
        ...
        <>
            ...
            <Head>
                <title>
                    Join the ISO; Initial Subscription Offering • Qarrington
                </title>
                <meta
                    name="description"
                    content={`When you join the whitelist for the subscription launch, you must add your phone number to your account to receive SMS 24hrs before the launch.`}
                />
            </Head>
                    ...
                    >
                        <Container maxWidth="sm">
                            ...
                            <Box style={{ textAlign: 'center' }}>
                                ...
                                <Box my={1}>
                                    <Tooltip title={`The ISO starts on Fri, May 20, 2023, at 11:45 PM EST and ends on Sat, May 27, 2023, at 11:45 PM EST.`} placement="top">
                            ...
                            <Container maxWidth="sm">
                                ...
                                <Box textAlign="center" mt={2}>
                                    <Typography component="span" variant="body2" fontWeight={600} color="black">
                                        An Initial Subscription Offering (ISO) allows you to buy the subscriptions of technology companies like before they're listed on a subscription exchange.
                                    </Typography>
                                </Box>
