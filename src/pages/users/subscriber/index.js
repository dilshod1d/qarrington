                        ...
                        <Grid my={8} item xs={7}>
                            ...
                            <Box style={{ padding: '0px 0px 0px 0px' }}>
                                <Typography variant="h1" fontWeight={700} color="black">
                                    How to use Qarrington as a SaaS Subscriber.
                                </Typography>
                                <Divider sx={{ my: 3 }} />
                                <Typography mt={1} variant="h5" fontWeight={500} color="secondary">
                                    A SaaS Subscriber is the individual or institutional customer of an early-stage startup company, where products are provided on a subscription basis.
                                </Typography>
                            </Box>
