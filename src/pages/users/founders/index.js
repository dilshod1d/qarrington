                            ...
                            <Grid item xs={12}>
                                ...
                                <Card style={{ padding: '60px', marginBottom: '10px' }}>
                                    <Typography variant="body" color="secondary" fontWeight={600}>
                                        A SaaS Founder is a startup founder of a company with a business model in which products are provided on a subscription basis.
                                    </Typography>
                                </Card>
...
const arrayItems = [
    ...
    },
    {
        ...
        title: "Push",
        detail: "Sell subscriptions to whitelisted users.",
        tooltip: ""
    }
]