...
const Page = () => {
    ...
    return (
        ...
        <>
            ...
            <Head>
                <title>How to Use Qarrington as a SaaS Founder • Qarrington</title>
                <meta
                    name="description"
                    content={`A SaaS Founder is a startup founder of an early-stage startup company with a business model in which products are provided on a subscription basis.`}
                />
            </Head>
                        ...
                        <Grid my={8} item xs={7}>
                            ...
                            <Box style={{ padding: '0px 0px 0px 0px' }}>
                                <Typography variant="h1" fontWeight={700} color="black">
                                    How to use Qarrington as a SaaS Founder.
                                </Typography>
                                <Divider sx={{ my: 3 }} />
                                <Typography mt={1} variant="h5" fontWeight={500} color="secondary">
                                    A SaaS Founder is a startup founder of an early-stage startup company with a business model in which products are provided on a subscription basis.
                                </Typography>
                            </Box>
...
const arrayItems = [
    ...
    },
    {
        ...
        title: "Push",
        detail: "Sell subscriptions to the whitelisted users.",
        tooltip: ""
    }
]