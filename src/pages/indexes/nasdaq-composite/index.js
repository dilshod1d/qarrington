    ...
    return (
        ...
        <>
            ...
            <Head>
                ...
                <meta
                    name="description"
                    content={`Buy & sell the subscriptions of innovative startups just like the Nasdaq Composite. However, instead of shares, it's product-backed subscriptions.`}
                />
            </Head>
                        ...
                        <Container maxWidth="sm">
                            ...
                            <Box style={{ textAlign: 'center' }}>
                                ...
                                <Typography fontSize="42px" fontWeight="700" lineHeight="50px" component="div" sx={{ my: 1 }}>
                                    Buying subscriptions vs the Nasdaq Composite
                                ...
                                <Typography variant="h6" component="div" color="secondary" padding="0px 20px 0px 20px" gutterBottom>
                                    We're building a subscription exchange, where you can buy & sell the subscriptions of startups. It's like the Nasdaq Composite, but instead of shares, it's product-backed subscriptions.
                                </Typography>
