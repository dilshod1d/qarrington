                        ...
                        <Grid my={8} item xs={7}>
                            ...
                            <Box style={{ padding: '0px 0px 0px 0px' }}>
                                <Typography variant="h1" fontWeight={700} color="black">
                                    How subscriptions can outperform the S&P 500 index stocks.
                                </Typography>
                                <Divider sx={{ my: 3 }} />
                                <Typography mt={1} variant="h5" fontWeight={500} color="secondary">
                                    Buy, sell, and trade the subscriptions of innovative startup companies just like the S&P 500. But instead of shares, it's product-backed subscriptions.
                                </Typography>
                            </Box>
