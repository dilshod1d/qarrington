    ...
    return (
        ...
        <>
            ...
            <Head>
                ...
                <meta
                    name="description"
                    content={`Buy & sell the subscriptions of innovative startups just like the S&P 500. However, instead of shares, it's product-backed subscriptions.`}
                />
            </Head>
                        ...
                        <Container maxWidth="sm">
                            ...
                            <Box style={{ textAlign: 'center' }}>
                                ...
                                <Typography fontSize="42px" fontWeight="700" lineHeight="50px" component="div" sx={{ my: 1 }}>
                                    How subscriptions can outrun the S&P 500
                                ...
                                <Typography variant="h6" component="div" color="secondary" padding="0px 20px 0px 20px" gutterBottom>
                                    We're building a subscription exchange, where you can buy & sell the subscriptions of startup companies. It's like the S&P 500 stocks, but instead of shares, it's product-backed subscriptions.
                                </Typography>
