...
const Page = () => {
    ...
    return (
        ...
        <>
            ...
            <Head>
                <title>How Subscriptions Can Outrun the Dow Jones Industrial Average • Qarrington</title>
                <meta
                    name="description"
                    content={`Buy & sell the subscriptions of innovative startups just like the Dow Jones Industrial Average. But instead of shares, it's product-backed subscriptions.`}
                />
            </Head>
                        ...
                        <Grid my={8} item xs={7}>
                            ...
                            <Box style={{ padding: '0px 0px 0px 0px' }}>
                                <Typography variant="h1" fontWeight={700} color="black">
                                    How subscriptions can outrun the Dow Jones Industrial Average.
                                </Typography>
                                <Divider sx={{ my: 3 }} />
                                <Typography mt={1} variant="h5" fontWeight={500} color="secondary">
                                    Buy & sell the subscriptions of innovative startups just like the Dow Jones Industrial Average. But instead of shares, it's product-backed subscriptions.
                                </Typography>
                            </Box>
