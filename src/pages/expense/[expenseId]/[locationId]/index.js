...
const Page = ({ expense, location }) => {
  ...
  return (
    ...
    <>
      ...
      <Head>
        <title>
          Cover Your {expense} Expenses in {location} • Qarrington
        </title>
        <meta
          name="description"
          content={`Qarrington is a subscription exchange that lets you buy and sell the subscriptions of technology companies to cover your ${expense} in ${location}.`}
        />
      </Head>
            ...
            <Container maxWidth="sm">
              ...
              <Box style={{ textAlign: 'center' }}>
                ...
                <Typography fontSize="42px" fontWeight="700" lineHeight="50px" component="div" sx={{ my: 1 }}>
                  Cover your {expense} expenses in {location}
                ...
                <Typography variant="h6" component="div" color="secondary" padding="0px 20px 0px 20px" gutterBottom>
                  Qarrington is a subscription exchange that lets you buy and sell the subscriptions of technology companies to fund your {expense} expenses in {location}. Think stocks, but backed by products.
                </Typography>
...
export async function getServerSideProps(context) {
  ...
  return {
    props: {
      expense: expenseResults.expenseName,
      location: locationResults.locationName
    }
  };
}