...
const Page = ({ url, name }) => {
  ...
  return (
    <>
      <Head>
        <title>
          Cover Your {name} Expenses With Subscriptions • Qarrington
        </title>
        <meta
          name="description"
          content={`Qarrington is a subscription exchange that lets you buy and sell the subscriptions of technology companies to cover your ${url} expenses.`}
        />
      </Head>
            ...
            <Container maxWidth="sm">
              ...
              <Box style={{ textAlign: 'center' }}>
                ...
                <Typography fontSize="42px" fontWeight="700" lineHeight="50px" component="div" sx={{ my: 1 }}>
                  Cover your {url} expenses in 2023
                ...
                <Typography variant="h6" component="div" color="secondary" padding="0px 20px 0px 20px" gutterBottom>
                  Qarrington is a subscription exchange, where you can buy and sell the subscriptions of technology companies to cover your {url} expenses. It's like stocks and cryptos, but backed by products.
                </Typography>
...
export async function getServerSideProps({ params }) {
  try {
    const results = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/api/expenses?expenseUrl=${params.expenseId.replace(/\-/g, '+')}`)
      .then((r) => r.json());
    return {
      props: {
        url: results.expenseUrl,
        name: results.expenseName
      }
    };
  } catch (error) {
    return {
