            ...
            <Container maxWidth="sm">
              ...
              <Box style={{ textAlign: 'center' }}>
                ...
                <Typography variant="h6" component="div" color="secondary" padding="0px 20px 0px 20px" gutterBottom>
                  If in any circumstances you can't remember your accountKey, just navigate to <Link href="/account/retake">
                    <Typography
                      component="span"
                      color="primary"
                      variant="h6"
                      ...
                      }}>account retake</Typography></Link> and enter your accountId. You'd need a new account if you can't remember your accountId.
                </Typography>
                ...
                <Box style={{ textAlign: 'center', padding: '14px 60px 0px 60px' }}>
                  ...
                  <Stack spacing={1.2} sx={{ width: '100%' }}>
                    ...
                    <TextField
                      ...
                      required
                      placeholder="Enter your accountKey"
                    />
