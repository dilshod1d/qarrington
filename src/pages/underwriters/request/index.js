...
const Page = () => {
          ...
          <Stack spacing={1.2} sx={{ width: '100%' }}>
            <Tooltip title="hint" placement="top">
              <TextField
                sx={{ input: { textAlign: "center" } }}
                required
                placeholder="Underwriter Industry"
              />
            </Tooltip>
          </Stack>
        );
          ...
          <Stack spacing={1.2} sx={{ width: '100%' }}>
            <Tooltip title="hint" placement="top">
              <TextField
                sx={{ input: { textAlign: "center" } }}
                required
                placeholder="Underwriter Description"
              />
            </Tooltip>
          </Stack>
        );
          ...
          <Stack spacing={1.2} sx={{ width: '100%' }}>
            <Tooltip title="hint" placement="top">
              <TextField
                sx={{ input: { textAlign: "center" } }}
                required
                placeholder="Underwriter Market"
              />
            </Tooltip>
          </Stack>
        );
          ...
          <Stack spacing={1.2} sx={{ width: '100%' }}>
            <Tooltip title="hint" placement="top">
              <TextField
                sx={{ input: { textAlign: "center" } }}
                required
                placeholder="Underwriter Website"
              />
            </Tooltip>
          </Stack>
        );
  ...
  return (
    ...
    <>
      ...
      <Head>
        <title>Request Access • Qarrington</title>
        <meta
          name="description"
...
const principles = [
  ...
  },
  {
    ...
    content: "Next, connect your bank account to your Qarrington account."
  },
  {
    _id: 3,
    name: "Request",
